...
patch -Np1 <<EOF
--- a/var/db/repos/gentoo/eclass/toolchain-funcs.eclass	2021-11-16 23:28:36.425419786 +0800
+++ b/var/db/repos/gentoo/eclass/toolchain-funcs.eclass	2021-11-16 23:29:30.378384948 +0800
@@ -675,6 +675,7 @@
 			fi
 			;;
 		ia64*)		echo ia64;;
...
crossdev -t "$TRIPLE" --without-headers --binutils 2.37_p1-r1 --gcc 12.0.0_pre9999
...
# gawk seems to have problems installing with concurrency
# and its deps include ncurses that needs disabling sandbox to correctly build under Docker
# so just turn off sandbox for all emerges
